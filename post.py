...
ORIGINAL_TOPICS = [
    ...
    "マルチタスクが苦手なADHDの仕事術",
    # AI × ADHD
    "ChatGPTをADHDの外部脳として使い始めたら何が変わったか",
    "ADHDの先延ばしをAIに伴走させて突破する方法",
    "AIに今日のタスクを整理させたら仕事が変わった話",
    "ADHDとAIの相性が異常にいい理由",
    "Claudeに「自分の思考を整理してもらう」使い方",
    "AIを使えばADHDの衝動的な意思決定を防げるか試してみた",
    "音声入力＋AI要約でADHDのメモ問題を解決した話",
    "ADHDにとってAIは薬より先に試すべきだったかもしれない",
    "ADHDの忘れっぽさをAIリマインダーで補う仕組み",
    "過集中をAIで管理する：タイマー以上の使い方",
]
...
- AI（ChatGPT・Claude等）との組み合わせが有効なテーマは積極的に取り上げる
